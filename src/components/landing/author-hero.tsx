  ...
  return (
    <section className="mx-auto grid max-w-5xl grid-cols-1 items-center gap-8 px-6 pt-12 pb-10 sm:px-8 sm:pt-16 md:grid-cols-[minmax(0,260px)_1fr] md:gap-12 lg:px-10 lg:pt-20 lg:pb-14 xl:grid-cols-[minmax(0,300px)_1fr] xl:gap-16">
      {siteConfig.authorPhotoUrl ? (
        <div className="relative mx-auto aspect-4/5 w-full max-w-64 overflow-hidden rounded-(--radius) bg-muted md:mx-0 xl:max-w-72">
          <Image
        ...
        <ImagePlaceholder
          ...
          className="mx-auto aspect-4/5 w-full max-w-64 rounded-(--radius) md:mx-0 xl:max-w-72"
        />
      )}
      ...
      <div className="max-w-2xl space-y-3 text-center md:text-left">
        ...
        <p className="mx-auto h-px w-16 bg-border md:mx-0" aria-hidden />
